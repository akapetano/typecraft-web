...
export const shadows = defineSemanticTokens.shadows({
  ...
  xl: {
    value: {
      ...
      _dark:
        "0px 8px 16px {colors.black.a8}, 0px 0px 1px inset {colors.gray.a7}",
    },
  },
  "2xl": {
    value: {
      _light: "0px 12px 24px {colors.gray.a4}, 0px 0px 1px {colors.gray.a4}",
      _dark:
        "0px 12px 24px {colors.black.a8}, 0px 0px 1px inset {colors.gray.a7}",
    },
  },
  inset: {
    value: {
